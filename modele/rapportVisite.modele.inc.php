...
function insertion($numrapport){
    ...
    $post=$_POST['motif'];
        ...
        $req = $monPdo->prepare('INSERT INTO rapport_visite (COL_MATRICULE, RAP_NUM, PRA_NUM, RAP_DATE, RAP_BILAN, RAP_MOTIF_AUTRE, DATE_VISITE, ID_ETAT, PRA_NUM_REMPLACANT, MOT_CODE, MED_DEPOTLEGAL_Presente1, MED_DEPOTLEGAL_Presente2) VALUES (?,?,?,?,?,?,?,?,?,?,?,?)');
        $req->execute(array($_SESSION['matricule'],$numrapport,$_POST['praticien'],$_POST['datesaisierapport'],$_POST['bilanrapportdevisite'],$_POST['autremotifcontent'],$_POST['datedevisite'],$id_etat,$_POST['remplacant'],$result[0][0],$_POST['med1'],$_POST['med2']));
        // var_dump($result);
