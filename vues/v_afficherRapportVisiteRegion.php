    ...
    <div class="container">
        ...
        <div class="row align-items-center justify-content-center">
            ...
            <div class="test col-9 col-sm-30 col-lg-30 col-x1-5 col-xx2-4 py-lg-30 py-30">
                ...
                <form action="#" method="post" class="formulaire-recherche col-12 m-0">
                ...
                <tbody>
                    ...
                    foreach (getReportDate(checkMatricule($_SESSION['matricule']))as $key){
                        echo '<tr><td>'.$key[1].'</td><td>'.$key[3].'</td><td>'.$key[4].'</td>' ?> <td><input class="btn btn-info text-light valider" type="submit" value="Détail rapport" onclick="localhost/nadot/GsbMedicament-main/GsbMedicament-main/index.php?uc=rapportsregions&action=afficherdetailrapport"></td></tr>'<?php ; 
